...
<script src="${pageContext.request.contextPath}/view/assets/js/preloader.js"></script>
      ...
      <div class="mdc-drawer__content">
        ...
        <div class="mdc-list-group">
          <nav class="mdc-list mdc-drawer-menu">
            ...
            <div class="mdc-list-item mdc-drawer-item">
              <a class="mdc-drawer-link" href="chartjs.jsp">
  ...
  <script src="${pageContext.request.contextPath}/view/assets/vendors/chartjs/Chart.min.js"></script>
  ...
  <script src="${pageContext.request.contextPath}/view/assets/js/chartjs.js"></script>
